...
struct GitHubAPI {
    ...
    static func userRepoURL(userName: String) -> URL {
        ...
        return URL(string: "https://api.github.com/users/\(userName)/repos?type=owner")!
    }
    
    static func repoLanguagesURL(_ userName: String, _ repositoryName: String) -> URL {
        return URL(string: "https://api.github.com/repos/\(userName)/\(repositoryName)/languages")!
    }
